...
export default function ArrowCard({ entry, pill }: Props) {
  return (
    <a
      ...
      class="group p-4 gap-3 flex items-center border rounded-lg hover:bg-black/5 hover:dark:bg-white/10 border-black/15 dark:border-white/20 transition-colors duration-300 ease-in-out h-full min-h-[200px]"
    >
      <div class="w-full group-hover:text-black group-hover:dark:text-white blend flex flex-col justify-between h-full">
        <div>
          ...
          <div class="text-sm line-clamp-2 mt-1 text-black/80 dark:text-white/80">
            {entry.data.summary}
          </div>
        </div>
